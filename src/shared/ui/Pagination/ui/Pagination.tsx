...
export const Pagination: FC<PaginationProps> = memo((props) => {
  ...
  return (
    <nav
      ...
      className={cn(cls.Pagination, {}, [className])}
      {...rest}
    >
      <ul className={cls.paginationContent}>
        <li tabIndex={1} className={cn(cls.paginationItem, backItemMods)}>
        ...
        {visiblePaginationPages.map((page) => {
          ...
          return (
            <li tabIndex={1} key={key} className={cn(cls.paginationItem, mods)} onClick={onClick}>
              {page}
            </li>
          )
        })}
        <li tabIndex={1} className={cn(cls.paginationItem, nextItemMods)}>
      ...
      <div className={cls.selectContainer}>
        ...
        <Select
          ...
          contentClassName={cls.selectContent}
        >
